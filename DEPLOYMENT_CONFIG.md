...
- ⬜ **Production ingestion runner** — briefs run from seeded golden fixtures, not live
  data. Build the ingestion runner (the unbuilt `hpi-worker`, D004); `daily-brief.yml` is
  the interim cadence bridge.
