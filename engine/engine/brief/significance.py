...
_SYSTEM = (
    ...
    "from 0.0 to 1.0. Score LOW (<0.4): routine commodity procurement (cellular/telecom "
    "service, office IT, facilities, leases, food/janitorial), filings that disclose no "
    "specific material event, stale or years-old actions resurfacing, generic administrative "
    "items. Score HIGH (>0.6): material capital deployment, new or strategically relevant "
    "programs/contracts/awards, technology breakthroughs, M&A and major financings, "
    "supply-chain or critical-mineral developments, consequential policy. Judge significance, "
    "not whether it is cited. Return only JSON: "
